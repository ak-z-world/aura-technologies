...
graph TD
    ...
    Services --> AI["AI Development & Agents"]
    Services --> CS["Custom Software Engineering"]
    Services --> CA["Cloud Architecture & DevOps"]
    Services --> DM["Digital Marketing & Tech SEO"]

    %% Products Branch
    VL --> Products["Proprietary Product Portfolio"]
    Products --> SCRIPTen["SCRIPTen (AI Content Engine)"]
    Products --> ERP["Vertex Loop ERP"]
    Products --> HRMS["Enterprise HRMS Platform"]
    Products --> INV["Digital Invoicing Software"]

    %% Dedicated Education Brand Branch
    VL --> CL["Crack Leap (Education Ecosystem)<br/>https://crackleap.vertexloop.in"]
    CL --> AI_Bootcamp["Applied AI & ML Bootcamps"]
    CL --> FS_Track["Full-Stack Software Architecture"]
    CL --> Cloud_Cert["Cloud & DevOps Engineering"]
    CL --> Corporate_Up["Corporate Tech Team Upskilling"]
```
