...
export default function EcosystemSection() {
  ...
  return (
    <section
      id="ecosystem"
      ref={sectionRef}
      className="relative py-10 md:py-2 overflow-hidden"
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
            ...
            <AnimatedSection variant="fadeUp" delay={0.14} className="max-w-md">
              <p className="text-slate-mid text-base leading-relaxed font-light">
                Each Vertex Loop division is independently elite. Integrated,
                they create an unfair advantage that no single-service provider
                can replicate.
              </p>
            </AnimatedSection>
          </div>
          ...
          <div className="glass-card-strong rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-display font-semibold text-slate-ink text-2xl md:text-3xl lg:text-4xl tracking-tight mb-4">
                ...
                <br />
                <span className="italic font-normal text-[#4a7fa5]">
                  the greater your returns.
                </span>
              </h3>
              <p className="text-slate-mid text-base max-w-2xl mx-auto leading-relaxed font-light mb-8">
                A company that trains talent through our Academy, builds
                products with our Software team, deploys on our IT
                infrastructure, and grows through our Marketing division — does
                not just save costs. They gain a strategic moat.
              </p>
