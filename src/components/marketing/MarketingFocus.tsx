import { Compass, Layers, BarChart2 } from 'lucide-react'

const FOCUS_PRINCIPLES = [
  {
    step: '01',
    title: 'Clarity',
    description: 'Understand the brand, audience, objectives and digital context.',
    icon: Compass,
  },
  {
    step: '02',
    title: 'Consistency',
    description: 'Create connected content and communication across relevant channels.',
    icon: Layers,
  },
  {
    step: '03',
    title: 'Measurement',
    description: 'Use analytics and performance data to understand digital activity and inform decisions.',
    icon: BarChart2,
  },
]

export default function MarketingFocus() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 mb-16 items-start">
          ...
          <div className="lg:col-span-6 lg:pt-8">
            <p className="text-sm md:text-base text-[#4b5563] font-light leading-relaxed">
              We work across search, content, social media, performance marketing, analytics and
              automation to build structured digital marketing systems around a brand&apos;s
              objectives.
            </p>
          </div>
        </div>
