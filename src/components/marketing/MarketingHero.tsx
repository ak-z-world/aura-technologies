...
export default function MarketingHero() {
  return (
    <section
      id="hero"
      aria-label="Digital Marketing Overview Hero"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            <h1 className="font-display text-[40px] sm:text-[52px] md:text-[62px] lg:text-[68px] xl:text-[74px] font-semibold text-[#111827] leading-[1.08] tracking-[-0.03em] max-w-2xl mb-6">
              ...
              content and
              <br />
              <span className="italic font-normal text-[#111827]">performance.</span>
            </h1>

            {/* Supporting Copy */}
            <p className="text-base sm:text-lg md:text-[18px] text-[#4b5563] font-light leading-relaxed max-w-xl mb-9">
              Vertex Loop Pvt Ltd provides digital marketing services across search, content,
              social media, performance marketing, analytics, automation and brand strategy.
            </p>
          ...
          {/* Right Column: Marketing Ecosystem Diagram */}
