...
const TIMELINE = [
  {
    year: "2026",
    title: "The Beginning",
    body: "Founded with a single conviction: that elite technology outcomes require cross-domain mastery, not siloed execution. The first division — Software Engineering — launched with three founding engineers.",
    accent: "#4a7fa5",
  },
  {
    year: "2026",
  ...
  },
  {
    ...
    body: "As LLMs moved from research papers to production systems, we moved with them. The AI Products division was born, pioneering enterprise-grade AI integrations years before the market caught on.",
    accent: "#3d8c7a",
  },
  {
    year: "2026",
    title: "Full Ecosystem",
    body: "IT Services and Digital Marketing joined the fold, completing the five-division ecosystem. For the first time, a client could trust a single partner from talent development to market growth.",
    accent: "#a07830",
  },
  // {
  //   year: "2026",
  //   title: "Global Scale",
  //   body: "Vertex Loop crossed 100 global clients, 2,000+ trained engineers, and established operations across three continents. The ecosystem model proved itself at enterprise scale.",
  //   accent: "#b04a4a",
  // },
];
...
const PRINCIPLES = [
  {
    ...
    body: "We are measured by what changes in your business — not by deliverables shipped or hours billed. Every engagement begins with a clear definition of success.",
    accent: "#4a7fa5",
  },
  {
    icon: Shield,
    title: "Architectural Integrity",
    body: "No shortcuts. No technical debt by design. Every system we touch is built to last, scale, and evolve — because we will be the ones maintaining it.",
    accent: "#7c6fad",
  },
  {
    icon: Lightbulb,
    title: "Frontier Thinking",
    body: "We invest 20% of our capacity in research and emerging technology. When a breakthrough becomes relevant to your business, we are already fluent in it.",
    accent: "#3d8c7a",
  },
  {
    icon: Heart,
    title: "Partnership Depth",
    body: "The best work emerges from genuine partnership. We invest in understanding your business, your culture, and your ambitions — not just your technical requirements.",
    accent: "#a07830",
  },
  {
    icon: Globe,
    title: "Global Perspective",
    body: "Our team spans continents. This diversity of market context, technical tradition, and cultural lens makes every solution more robust and more globally competitive.",
    accent: "#b04a4a",
  },
  {
    icon: Zap,
    title: "Relentless Velocity",
    body: "Speed is a competitive advantage. We run lean, decide fast, and ship without ceremony — while maintaining the quality standards that come from eight years of practice.",
    accent: "#4a7fa5",
  },
];
...
export default function AboutPageClient() {
  ...
  return (
    <main className="relative overflow-hidden">
      ...
      <section
        ref={manifestoRef}
        className="relative py-25 pt-5 overflow-hidden">
        ...
        <div className="relative z-10 section-padding max-w-5xl mx-auto">
          <AnimatedSection variant="fadeUp">
            <SectionLabel accent="lavender" className="mb-8">
              Our Manifesto
            </SectionLabel>
          </AnimatedSection>
              ...
              return (
                <motion.div
                  ...
                  <div
                    ...
                    style={{
                      background: `radial-gradient(ellipse at 0% 0%, ${p.accent}10, transparent 65%)`,
                    }}
                  />
                  <div
            ...
            {LEADERSHIP.map((person) => (
              <motion.div
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(90deg, ${person.accent}80, transparent)`,
                  }}
                />
                <h3 className="font-semibold text-slate-ink text-base tracking-tight mb-1">
                  {person.name}
                </h3>
                <div
        ...
        <div className="relative z-10 section-padding text-center max-w-3xl mx-auto">
          <AnimatedSection variant="scaleIn">
            ...
            <p className="text-slate-mid text-lg font-light mb-8">
              Whether you know exactly what you need or are still defining the
              problem — we are the right room to be in.
            </p>
