...
> = {
  academy: {
    ...
    process: [
      {
        ...
        desc: "We map your skill gaps or individual goals against market requirements.",
      },
      {
        step: "02",
        label: "Curriculum Design",
        desc: "Custom or cohort tracks built around real production scenarios.",
      },
      {
        step: "03",
        label: "Intensive Training",
        desc: "Project-based, mentorship-heavy, zero-theory bloat programs.",
      },
      {
        step: "04",
        label: "Outcome Tracking",
        desc: "Placement support, performance reviews, and post-completion mentorship.",
      },
    ],
    deliverables: [
    ...
    idealFor: [
      "Enterprises upskilling teams",
      "Startups building engineering bench",
      "Career-changing professionals",
      "Universities seeking industry curriculum",
    ],
    caseStudy: {
      title: "FinStack Technologies",
      result: "42 engineers upskilled in 12 weeks",
      detail:
        "Designed and delivered a custom AI/ML training track for FinStack's engineering team, resulting in the company shipping their first AI-powered feature set within one quarter.",
    },
  },
  "ai-products": {
    longDesc:
    ...
    process: [
      {
        ...
        desc: "Assess what AI can genuinely add versus what is marketing noise.",
      },
      {
        step: "02",
        label: "Architecture Design",
        desc: "Model selection, pipeline design, data strategy, and infra planning.",
      },
      {
        step: "03",
        label: "Build & Evaluate",
        desc: "Iterative development with rigorous evals, red-teaming, and benchmark testing.",
      },
      {
        step: "04",
        label: "Production & Monitoring",
        desc: "Deployment, observability, drift detection, and continuous improvement.",
      },
    ],
    deliverables: [
    ...
    idealFor: [
      ...
      "AI-first startups",
      "Research teams productizing models",
    ],
    caseStudy: {
      title: "LegalEdge Platform",
      result: "89% reduction in document review time",
      detail:
        "Built a multi-agent RAG system for contract analysis, combining fine-tuned legal LLMs with structured extraction pipelines — cutting review time from hours to minutes.",
    },
  },
  "it-services": {
    longDesc:
    ...
    process: [
      {
        ...
        desc: "Comprehensive assessment of current state, risk, and opportunity.",
      },
      {
        step: "02",
        label: "Architecture Blueprint",
        desc: "Cloud-native design with security, compliance, and scale baked in.",
      },
      {
        step: "03",
        label: "Migration & Deployment",
        desc: "Zero-downtime migrations with rollback safeguards at every stage.",
      },
      {
        step: "04",
        label: "Managed Operations",
        desc: "24/7 NOC, proactive monitoring, incident response, and optimization.",
      },
    ],
    deliverables: [
    ...
    caseStudy: {
      ...
      detail:
        "Redesigned and migrated a 12-year-old on-premise banking infrastructure to a multi-region AWS architecture with full SOC 2 Type II compliance.",
    },
  },
  software: {
    longDesc:
    ...
    process: [
      {
        ...
        desc: "Deep-dive into requirements, constraints, existing architecture, and non-negotiables.",
      },
      {
        step: "02",
        label: "System Design",
        desc: "Architecture document, data model, API contracts, and technology decisions ratified before code.",
      },
      {
        step: "03",
        label: "Iterative Build",
        desc: "Sprint-based delivery with CI/CD, automated testing, and weekly demos.",
      },
      {
        step: "04",
        label: "Handoff & Support",
        desc: "Comprehensive documentation, knowledge transfer, and optional ongoing support.",
      },
    ],
    deliverables: [
    ...
    idealFor: [
      "Startups building core product",
      "Enterprises modernizing legacy systems",
      "Teams needing surge capacity",
      "Products requiring specialized architecture",
    ],
    caseStudy: {
      title: "TradeFlow Logistics",
      result: "12× throughput improvement",
      detail:
        "Redesigned a monolithic order management system into an event-driven microservices architecture, reducing P99 latency from 3.2s to under 180ms at 10× peak load.",
    },
  },
  "digital-marketing": {
    longDesc:
    ...
    process: [
      {
        ...
        desc: "Competitive landscape, audience mapping, channel audit, and positioning analysis.",
      },
      {
        step: "02",
        label: "Strategy Architecture",
        desc: "Full-funnel strategy with AI-powered content planning and channel allocation.",
      },
      {
        step: "03",
        label: "Campaign Execution",
        desc: "Creative production, campaign launch, and daily performance optimization.",
      },
      {
        step: "04",
        label: "Analytics & Attribution",
        desc: "Custom dashboards, multi-touch attribution, and monthly strategy reviews.",
      },
    ],
    deliverables: [
    ...
    idealFor: [
      "B2B SaaS companies",
      "D2C brands scaling acquisition",
      "Enterprises relaunching brands",
    ...
    caseStudy: {
      ...
      detail:
        "Built a full-funnel performance marketing system integrating AI-generated ad variants, dynamic bidding, and closed-loop attribution — from zero to $2M monthly ad spend profitably.",
    },
  },
};
    ...
    <motion.button
      ...
      <div
        ...
        {IconComponent && (
          <IconComponent
            size={17}
            style={{ color: isActive ? accent.color : "#94a3b8" }}
          />
        )}
      </div>
      <span
        className={`text-sm font-medium transition-colors duration-200 ${isActive ? "text-slate-ink" : "text-slate-dim"}`}>
        {division.title}
      </span>
    </motion.button>
  );
...
">
        {/* Header card */}
        <div className="glass-card-strong rounded-3xl p-5 sm:p-6 xl:p-7 relative overflow-hidden">
          <div
          ...
          <div className="relative z-10">
            <div className="flex items-start gap-5 mb-6">
              <div
                ...
                style={{
                  background: `${accent.color}16`,
                  border: `1.5px solid ${accent.color}30`,
                }}>
                {IconComponent && (
                  <IconComponent size={28} style={{ color: accent.color }} />
                )}
              </div>
              <div>
                <div
                  className="text-xs font-mono tracking-[0.1em] uppercase mb-1.5"
                  style={{ color: accent.color }}>
                  {division.tagline}
                </div>
                <h2 className="text-display font-semibold text-slate-ink text-3xl tracking-tight">
                  {division.title}
                </h2>
              </div>
            </div>
            <p className="text-slate-mid leading-relaxed text-base font-light">
              {detail.longDesc}
            </p>
        ...
        <div className="glass-card rounded-3xl p-7">
          <h3 className="font-semibold text-slate-ink text-lg mb-6 tracking-tight">
            How we work
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {detail.process.map((p) => (
              <div
                key={p.step}
                className="flex items-start gap-4 p-4 rounded-2xl bg-white/50 border border-white/60">
                <div
                ...
                <div>
                  <div className="font-medium text-slate-ink text-sm mb-1">
                    {p.label}
                  </div>
                  <div className="text-slate-dim text-xs leading-relaxed">
                    {p.desc}
                  </div>
                </div>
              </div>
...
">
        ...
        <div className="glass-card rounded-2xl p-6">
          ...
          <div className="flex flex-col gap-2">
            {detail.idealFor.map((f) => (
              <span key={f} className="tag-pill justify-start">
                {f}
              </span>
            ))}
          </div>
        ...
        <div
          ...
          <div className="font-semibold text-slate-ink text-sm mb-1">
        ...
        <div className="relative z-10 section-padding">
          <motion.div
            ...
            {DIVISIONS.map((division) => {
              const accent =
                ACCENT_CONFIGS[division.id as keyof typeof ACCENT_CONFIGS];
              const IconComponent = ICON_MAP[division.icon];
              return (
                <motion.button
                  key={division.id}
                  ...
                  onClick={() => {
                    ...
                    document
                      .getElementById("division-detail")
                  ...
                  <div
                    ...
                    style={{
                      background: `radial-gradient(ellipse at 50% 0%, ${accent.color}12, transparent 70%)`,
                    }}
                  />
                  <div
                  ...
                  <div className="text-sm font-medium text-slate-ink">
                    {division.title}
                  </div>
                  <div className="text-xs text-slate-dim mt-1 font-mono">
                    {division.stats.value}
                  </div>
                  <div className="text-[10px] text-slate-dim/70 font-mono">
        ...
        <div className="relative z-10 section-padding">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              {[
                {
                  combo: "Academy + Software",
                  benefit:
                    "Train and build simultaneously — teams learn on your real product",
                  icon: "🎓 + 💻",
                },
                {
                  combo: "AI Products + IT Services",
                  benefit:
                    "Ship AI systems with the infrastructure to run them at scale",
                  icon: "🤖 + 🏗️",
                },
                {
                  combo: "Software + Digital Marketing",
                  benefit:
                    "Build the product and the growth engine in one coordinated motion",
                  icon: "⚙️ + 📈",
                },
                {
                  combo: "All Five Divisions",
                  benefit:
                    "The compounding advantage — talent, technology, infrastructure, and growth",
                  icon: "⚡",
                },
              ].map((item) => (
                <motion.div
        ...
        <div className="relative z-10 section-padding text-center max-w-3xl mx-auto">
          <AnimatedSection variant="scaleIn">
            ...
            <p className="text-slate-mid text-lg font-light mb-8">
              Tell us what you are building, and we will tell you exactly how
              Vertex Loop can help — from a single division to the full
              ecosystem.
            </p>
